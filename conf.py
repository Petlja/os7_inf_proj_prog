...
project = 'Пројектна настава за седми разред - Pygame'
#pylint: disable=redefined-builtin
copyright = '2021 Petlja'
...
html_context = {'course_id': 'Projektni_Pygame',
...
html_theme_options = {
    ...
    'navbar_title': "Пројектна настава за седми разред - Pygame",
...
html_title = 'Пројектна настава за седми разред - Pygame'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Пројектна настава за седми разред - Pygame'
...
htmlhelp_basename = 'Projektni_Pygame-doc'
